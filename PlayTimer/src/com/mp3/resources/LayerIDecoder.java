...
class LayerIDecoder implements FrameDecoder
{
	...
	public void create(SoundStream stream0, Frame header0,
	...
	static abstract class Subband
	{
	  ...
	  */
	  ...
	  public abstract void read_allocation (SoundStream stream, Frame header, Crc16 crc) throws DecoderException;
	  public abstract void read_scalefactor (SoundStream stream, Frame header);
	  public abstract boolean read_sampledata (SoundStream stream);
