...
/*				 Toolkit.getDefaultToolkit().setDynamicLayout(true);
			...
			// Auto-start the main window and load schedules immediately.
			// This fixes the startup bug: previously schedules were only loaded
			// when the user clicked the tray icon. Now they load on app launch,
			// so auto-start plays music at the first scheduled time.
